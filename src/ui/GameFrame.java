...
public class GameFrame extends JFrame implements PropertyChangeListener {
    ...
    private void showWinMessage() {
        ...
        sbL.append("You Win! Your score was: ");
        sbL.append(model.score());
        Object[] options = {"Yes, continue",
                "No, close the game"};
        int n = JOptionPane.showConfirmDialog(this, "Would you like to continue playing",
                sbL.toString(), JOptionPane.YES_NO_OPTION); //JOptionPane.PLAIN_MESSAGE
    ...
    private void showLoseMessage() {
        StringBuilder sbL = new StringBuilder();
        sbL.append("You lost! Your score was: ");
        sbL.append(model.score());
        Object[] options = {"Yes, continue",
                "No, close the game"};
        int n = JOptionPane.showConfirmDialog(this, "Would you like to continue playing",
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        Object dyn = evt.getNewValue();
        if (dyn == GameState.VICTORY) {
            showWinMessage();
        } else if (dyn == GameState.DEFEAT) {
            showLoseMessage();
        }
    }
}
